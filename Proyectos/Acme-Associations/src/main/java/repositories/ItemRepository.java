...
public interface ItemRepository extends JpaRepository<Item, Integer> {
	...
	@Query("select i from Item i where i.itemCondition!='LOAN' and (i.name like %?1% or i.identifier=?1 or i.description like %?1% or i.section.name like %?1% or i.section.association.name like %?1%)")
